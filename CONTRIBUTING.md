...
Contributions are **welcome** and accepted via Pull Requests on [Github](https://github.com/anorgan/laravel-cache).
...
- **Provide tests!** Your patch won't be accepted if it doesn't have tests.
